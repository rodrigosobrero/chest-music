       ...
       <Breadcrumb className='px-3 md:px-0' items={paths}/>
        ...
        <div className='bg-neutral-black rounded-3xl md:p-8 flex flex-row gap-10'>
            ...
            <button
             ...
             onClick={()=>console.log(user?.token)}
             >
            ...
            <h4 className='!text-lg !font-archivo !normal-case text-neutral-silver-300 truncate'>https://chestmusic.com/beta/1294tn2389sfgeh</h4>
            </div>
            </div>
