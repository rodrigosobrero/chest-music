...
const DeleteModal = ({ title, subtitle, confirmText, primaryButton, secondaryButton, toggle, placeholder, disabled, onChange }) => {
  ...
  return (
    <div className='w-[32rem] text-center flex flex-col  gap-y-8'>
        ...
        <div className='font-archivo font-semibold flex gap-4'>
            ...
            <button onClick={toggle} className='w-full bg-brand-gold text-black py-2.5 px-6 
