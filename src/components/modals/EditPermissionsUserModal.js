...
import { useUpdateSharedUserMutation } from 'store/api';
...
export default function EditPermissionsUserModal(props) {
  const { t } = useTranslation();
  const [updateUserPermissions, { isLoading }] = useUpdateSharedUserMutation();
