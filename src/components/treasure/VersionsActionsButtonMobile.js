...
export default function VersionsActionsButtonMobile({ version }) {
  ...
  return (
    <ContextButton options={options} action={handleAction} isOpened={isOpened} toggleOptions={toggleOptions} closeOptions={closeOptions} mobile={true}/>
  )
}